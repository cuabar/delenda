...
if($password == 'planetCHECKdel413tSs')
{
	...
	while($planetarray = mysql_fetch_array($getallplanets))
	{
		...
		//Give Missions
		//Basic Missions
		$updateauthmissions = mysql_query("UPDATE zonemissions SET mission=1, mission2=4, mission3=7, mission4=13 WHERE battlezone='$zoneid' AND allegiance='authority'");
		$updatemercmissions = mysql_query("UPDATE zonemissions SET mission=2, mission2=5, mission3=8, mission4=14 WHERE battlezone='$zoneid' AND allegiance='mercantile'");
		$updatesolmissions = mysql_query("UPDATE zonemissions SET mission=3, mission2=6, mission3=9, mission4=15 WHERE battlezone='$zoneid' AND allegiance='solidarity'");
